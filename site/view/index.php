...
<body>
    ...
    <div class="container">
		<div class="header">
			<!-- Barre de navigation -->
				<div id="bar" class="navbar navbar-inverse ">
					...
					<a id="exia" class="brand" href="#">EXI@STORE</a>
						
					<!-- Structure du menu -->
						<div class="nav-collapse collapse">
							<ul class="nav">
								<form class="navbar-search pull-right" action="#">
								<input id="search" type="text" class="search-query span2 pull-right " placeholder="Search">
								<input type="text" class="login span2 " placeholder="Login">
								<input type="password" class="pass span2 " placeholder="Password">
								<ul id="bouton" href="#" class="btn btn-inverse btn-small nav">Connect</ul>
								<ul id="bouton" href="#" class="btn btn-inverse btn-small nav">Subscribe</ul>
								<button id="basket" class="btn btn-inverse btn-small"><i class="icon-white icon-shopping-cart"></i> </button>
								</form>
							</ul>
						</div>
					</div>
		...
		<div class="topsell">
			<img src="C:\Users\Cyprien\Desktop\documentstravail\projet web\blabla.jpg" alt=""/>
				<h4>blabla</h4>
					<p>aifhiuahfoaihfauvzvzbuivzbiuzb</p>
			<img src="C:\Users\Cyprien\Desktop\documentstravail\projet web\hebus2.jpg" alt=""/>
		</div>
		<div class="content">
			...
			<div class="caroussel">
				<div id="myCarousel" class="carousel slide">
					...
					<div class="carousel-inner">
						...
						<div class="item">
							<img src="C:\Users\Cyprien\Desktop\documentstravail\projet web\hebus.jpg" alt=""/>
								<div class="carousel-caption">
									<h4>2eme slide</h4>
										<p>description de l'image</p>
								</div>
